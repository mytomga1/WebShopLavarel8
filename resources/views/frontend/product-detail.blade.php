                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="product__details-nav d-sm-flex align-items-start">
                            <!-- multi ảnh sản phẩm ổ nhỏ bên trái-start -->
...
{{--                                        <img src="{{ asset('frontend') }}/img/product/nav/product-nav-1.jpg" alt="">--}}
{{--                                    </button>--}}
{{--                                </li>--}}
...
{{--                                        <img src="{{ asset('frontend') }}/img/product/nav/product-nav-2.jpg" alt="">--}}
{{--                                    </button>--}}
{{--                                </li>--}}
{{--                                <li class="nav-item" role="presentation">--}}
...
{{--                                        <img src="{{ asset('frontend') }}/img/product/nav/product-nav-3.jpg" alt="">--}}
{{--                                    </button>--}}
{{--                                </li>--}}
{{--                                <!-- multi ảnh sản phẩm -end -->--}}
{{--                            </ul>--}}
                            <!-- multi ảnh sản phẩm ổ nhỏ bên trái-end -->
                            ...
                            <div class="product__details-thumb">
                                <div class="tab-content" id="productThumbContent">
                                    ...
                                    {{--@foreach($product->images() as $img)
                                        ...
                                        gợi ý làm chức năng multi hình ảnh

                                        @endforeach--}}

{{--                                    <div class="tab-pane fade" id="thumbTwo" role="tabpanel" aria-labelledby="thumbTwo-tab">--}}
{{--                                        <div class="product__details-nav-thumb w-img">--}}
{{--                                            <img src="{{ asset('frontend') }}/img/product/nav/product-nav-big-3.jpg" alt="">--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <div class="tab-pane fade" id="thumbThree" role="tabpanel" aria-labelledby="thumbThree-tab">--}}
{{--                                        <div class="product__details-nav-thumb w-img">--}}
{{--                                            <img src="{{ asset('frontend') }}/img/product/nav/product-nav-big-2.jpg" alt="">--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
                                    <!-- multi ảnh sản phẩm -end -->
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="product__details-content">
                            ...
                            <!-- khu vực chức năng đánh giá sp -start -->
