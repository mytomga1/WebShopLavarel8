...
{{--                        <a href="product.html">See All Category <i class="fal fa-chevron-right"></i></a>--}}
{{--                    </div>--}}
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="{{ route('category', ['category' => $category->slug ]) }}"><img src="
                                                                            @if($category->image && file_exists(public_path($category->image)))
                                                                                {{ asset($category->image) }}
                                                                            @else
                                                                                {{ asset('frontend\img\categorie\cat-size.jpg') }}
                                                                            @endif
