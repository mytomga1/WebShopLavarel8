 ...
 * --> php artisan make:migration add_softdelete_to_vendors_table --table=vendors
 *
 ...
 * --> php artisan migrate --path=/database/migrations/2022_08_12_183911_add_softdelete_to_vendors_table.php
 */
